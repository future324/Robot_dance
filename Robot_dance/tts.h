...
{
	HWND hwnd = FindWindow(L"mywindow", L"智能问诊服务机器人");
	...
	BitBlt(g_hdc, Rect.left, Rect.top, Rect.right- Rect.left, Rect.bottom- Rect.top, g_mdctemp, Rect.left, Rect.top, SRCCOPY);    //采用BitBlt函数贴图，参数设置为窗口大小
